...
namespace MovieStoreGeneratedApp.Controllers
{
    public class ActorController : Controller
    {
        ...
        public ActorController(MovieStoreGeneratedDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Actors != null ? 
                          ...
                          Problem("Entity set 'MovieStoreGeneratedDbContext.Actors'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MovieStoreGeneratedDbContext.Actors'  is null.");
            }
            var actor = await _context.Actors.FindAsync(id);
            if (actor != null)
            {
